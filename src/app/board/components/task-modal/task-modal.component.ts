...
export class TaskModalComponent implements OnDestroy {
  ...
  constructor(private route: ActivatedRoute, private router: Router, private boardService: BoardService, private tasksService: TasksService, private fb: FormBuilder, private socketService: SocketService
  ) {
